       ...
       <div class="row">
            ...
            <h1>Hello, Themadag</h1>
                ...
                <form action="submit.php" method="post">
                    <input class="form-control mt-2" type="text" name="name" placeholder="Geef uw naam">
                    <input class="form-control mt-2" type="email" name="email" placeholder="Geef uw email">
                    <input class="form-control mt-2" type="text" name="tel" placeholder="Geef uw telefoon">
                    <hr>
                    <?php 
